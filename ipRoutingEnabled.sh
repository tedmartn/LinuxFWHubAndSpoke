...
sudo ip route add 172.16.0.0/16 via 10.0.1.1 dev eth1

# force iptables and routing on boot
echo '#!/bin/bash
/sbin/iptables-restore < /etc/iptables/rules.v4
sudo ip route add 172.16.0.0/16 via 10.0.1.1 dev eth1'| sudo tee -a /etc/rc.local && sudo chmod +x /etc/rc.local